  ...
  return (
    ...
    >
        ...
        <div className={`flex items-center gap-3 overflow-hidden ${collapsed ? 'justify-center w-full' : ''}`}>
          ...
          {!collapsed && (
            <motion.h1
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-500 to-purple-600 whitespace-nowrap"
            >
              ReviewMyCode
            </motion.h1>
          )}
      ...
      <button
        ...
        className="absolute -right-3 top-8 bg-surface border border-border rounded-xl p-1 text-gray-400 hover:text-white hover:border-gray-500 transition-colors z-30"
      >
      ...
      <div className="p-4 mt-auto">
        <div className={`p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-indigo-600/10 border border-indigo-500/20 flex flex-col gap-3 overflow-hidden ${collapsed ? 'items-center px-2' : ''}`}>
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600/20 flex items-center justify-center shrink-0">
            <span className="text-transparent bg-clip-text text-xs font-bold">PRO</span>
          </div>
          {!collapsed && (
            <div>
