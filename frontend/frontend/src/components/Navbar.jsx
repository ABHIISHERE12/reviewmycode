      ...
      <div className="flex items-center gap-4 lg:gap-6">
        ...
        <div className="flex items-center gap-3">
          {user?.githubConnected ? (
            ...
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-white/10 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-full border border-white/10 overflow-hidden relative">
              ...
              <img 
                src={user?.githubAvatar || `https://ui-avatars.com/api/?name=${user?.name || "User"}&background=random`} 
                alt="Profile" 
