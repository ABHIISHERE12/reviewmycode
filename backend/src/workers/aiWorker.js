...
const aiWorker = new Worker(
  ...
  async (job) => {
    ...
    try {
      ...
      // 3. Send diff to AI for analysis
      ...
      // 4. Save review result to database
      ...
      pr.riskScore = 100 - analysisResult.score; // Inverse of code health
      await pr.save();

      // 6. Update Repository health score average
      // Simplified: Just use the latest PR's score as an example
